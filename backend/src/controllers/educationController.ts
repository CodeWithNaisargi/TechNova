 ...
 */
export const getEducationLevel = async (req: Request, res: Response) => {
    try {
 ...
 */
export const updateEducationLevel = async (req: Request, res: Response) => {
    try {
        const userId = req.user?.id;
 ...
 */
export const getAllEducationLevels = async (_req: Request, res: Response) => {
    try {
        const levels = [
